...
const AboutPage: React.FC = () => {
  return (
    <div className="main-content_section">
      <h1>About Me</h1>
      <p>
        Email marketer turned full stack web developer. When I'm not your guy in
        the chair, you can find me picking up heavy things and setting them back
        down in the gym, grabbing a nice craft beer at a local brewery, or
        living out my best elder emo life singing along with a crowd to
        nostalgic pop punk.
      </p>
      <p>Always remember:</p>
